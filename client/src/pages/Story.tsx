  ...
  const sortedStory = [
    {
      ...
      content: "It started online — just two strangers talking. But from our very first conversation, something felt different. What was supposed to be casual slowly became constant. You became the person I looked forward to every single day.",
    ...
    {
      id: 2,
      title: "Growing Through Us",
      content: "As the days turned into months and the months into years, we grew — not just closer, but stronger. We laughed, we dreamed, we planned. But we also argued. We misunderstood each other. And sometimes… I hurt you. There were moments when my ego was louder than my love. Moments when I broke you without meaning to. And I carry that with me. But even in our hardest times, one thing never changed — I cared. I still care. Deeply.",
    ...
    },
    {
      ...
      content: "Six years later, here we are. Not perfect. Not flawless. But real. We’ve had fights. We’ve had tears. But we’ve also had growth, forgiveness, and understanding. Aditi, my wifeyyyyy… Since the day we met online, my life has never been the same. You changed how I love. You changed how I think. You changed me. And today, on our anniversary, I don’t just say I love you because it sounds good. I say it because after everything — I still choose you. I still want you. I still see my future with you.",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header ref={headerRef} className="text-center py-12 sm:py-16 md:py-24 px-4 relative">
          ...
          >
            ...
            >
              Six years ago, a simple hello on the PP changed everything.
I didn’t know it then, but I had just met the person who would reshape my world.
            </motion.p>
          </motion.div>
