    ...
    >
      ...
      >
        ...
        >
          ...
          >
            I've been carrying this in my heart.....
          </motion.span>
          ...
          >
            <p className="text-sm sm:text-base md:text-lg text-rose-700/80 font-light italic leading-relaxed px-4">
              We had a small fight, and maybe we both felt a little hurt.
              <br />
But even on days we don’t agree, I still choose you.
<br />
              <br />
              <span className="text-pink-600/90">You matter to me more than my ego ever will.</span>
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            Click the heart when you're ready, Wifeyyyyy…
          </motion.p>
